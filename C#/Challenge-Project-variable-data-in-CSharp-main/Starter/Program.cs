...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            string[] dogCharacteristicArray = dogCharacteristics.Split(", ");
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                {
                    bool doesDogMatch = false;

                    // Search combined descriptions and report results
                    dogDescription = ourAnimals[i, 4] + "\r\n" + ourAnimals[i, 5];


                    foreach (string dogCharacteristic in dogCharacteristicArray)
                    {
                        for (int j = 5; j > -1; j--)
                        {
                            ...
                            {
                                Console.Write($"\rsearching our dog {ourAnimals[i, 3]} for {dogCharacteristic} {(j != 0 ? icon : "*")} {j}");
                                Thread.Sleep(250);
